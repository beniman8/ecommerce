...
class PaymentView(View):
    ...
    def get(self,*args, **kwargs ):
        ...
        if order.billing_address:
            context = {
                'order': order,
                'DISLAY_COUPON_FORM':False
            }
            return render(self.request,"payment.html", context)
        else:
            messages.warning(self.request, "There is no biling adress")
            return redirect("core:checkout")
    ...
    def post(self,*args, **kwargs ):
        ...
        try:
            ...
            order.ref_code=creat_ref_code()
            order.save()

            

            messages.success(self.request, "Your order as successful! "+token+"hey ")
            return redirect("/")
            ...
            messages.warning(self.request,"Network communication failed")
            return redirect("/")
